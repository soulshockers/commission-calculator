...
readonly class EuCommissionCalculationStrategy extends AbstractCommissionCalculationStrategy
{
    ...
    {
        return round($this->calculateFixedAmount($transactionDTO) * 0.01, 2);
    }
}